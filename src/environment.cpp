...
Environment::Environment():x0(0),y0(0),x1(0),y1(0),x_start(0), y_start(0),x_end(0), y_end(0),baseResolution(2){}
...
double
Environment::dist(const double ax,const double ay,const double bx,const double by)const
{
...
QuadTreeNode::QuadTreeNode(double topleftX, double topleftY, double gridSize, int depth):
...
QuadTreeNode::split()
{
	...
	//	<< topleftY << "]" << endl;
	QuadTreeNode *nodeOne = new QuadTreeNode(topleftX, topleftY, gridSize/2,depth+1);
	QuadTreeNode *nodeTwo = new QuadTreeNode(centerX, topleftY, gridSize/2,depth+1);
	QuadTreeNode *nodeThree = new QuadTreeNode(topleftX, centerY, gridSize/2,depth+1);
	QuadTreeNode *nodeFour = new QuadTreeNode(centerX, centerY, gridSize/2,depth+1);
